    ...
    <>
      ...
      <form className="my-4 w-full" onSubmit={handleSubmitFeedback}>
        <textarea
          ...
          className="min-w-[304px] w-full min-h-[112px] text-sm placeholder:text-zinc-400 text-zinc-100 bg-transparent rounded-md focus:border-brand-500 focus:ring-brand-500 focus:ring-1 focus:outline-none resize-none scrollbar scrollbar-thumb-zinc-700 scrollbar-track-transparent scrollbar-thin"
        ...
        <footer className="flex gap-2 mt-2">
          ...
          <button
            disabled={comment.length === 0 && comment.length <= 0}
            type="submit"
